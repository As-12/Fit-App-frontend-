...
@Component({
  ...
  template: `
    ...
    <span
      data-toggle="modal"
      data-target="#privacyModalDialog"
      data-backdrop="false"
    >
      Privacy Policy
    </span>
    ...
    <div
      class="modal fade"
      id="privacyModalDialog"
      tabindex="-1"
      role="dialog"
      aria-labelledby="privacyModalDialogTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-black-50" id="privacyModalDialogTitle">
              Privacy Policy
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body text-black-50">
            ...
            <p>
              Thanaphon Chavengsaksongkram built the Fit-App app as an Open
              Source app. This SERVICE is provided by Thanaphon at no cost and
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at Fit-App unless
            ...
            <p>
              ...
              information, including but not limited to age, sex, height,
              weight. The information that I request may be retained in our
              database server to deliver the service.
            </p>
            <!---->
            ...
            <p>This policy is effective as of 2020-04-17</p>
            <p><strong>Contact Us</strong></p>
            <p>
              If you have any questions or suggestions about my Privacy Policy,
              do not hesitate to contact me at contact@thanaphon.dev.
            </p>
          </div>
